...
class InteractiveView(discord.ui.View):
    ...
    @discord.ui.button(style=discord.ButtonStyle.blurple, label="(", row=0)
    ...
    @discord.ui.button(style=discord.ButtonStyle.red, label="AC", row=0)
    async def clear(self, button: discord.ui.Button, interaction: discord.Interaction):
        self.expr = ""
        await interaction.message.edit(content=f"```\n{self.expr}\n```")

    @discord.ui.button(style=discord.ButtonStyle.red, label="BACK", row=0)
    async def back(self, button: discord.ui.Button, interaction: discord.Interaction):
        self.expr = self.expr[:-1]
        await interaction.message.edit(content=f"```\n{self.expr}\n```")

    @discord.ui.button(style=discord.ButtonStyle.secondary, label=" ", row=0)
    async def bruh1(self, button: discord.ui.Button, interaction: discord.Interaction):
        self.expr = ""

    @discord.ui.button(style=discord.ButtonStyle.secondary, label="7", row=1)
    async def seven(self, button: discord.ui.Button, interaction: discord.Interaction):
        self.expr += "7"
        await interaction.message.edit(content=f"```\n{self.expr}\n```")

    @discord.ui.button(style=discord.ButtonStyle.secondary, label="8", row=1)
    async def eight(self, button: discord.ui.Button, interaction: discord.Interaction):
        self.expr += "8"
        await interaction.message.edit(content=f"```\n{self.expr}\n```")

    @discord.ui.button(style=discord.ButtonStyle.secondary, label="9", row=1)
    ...
    @discord.ui.button(style=discord.ButtonStyle.secondary, label="  ", row=1)
    async def bruh2(self, button: discord.ui.Button, interaction: discord.Interaction):
        self.expr = ""

    @discord.ui.button(style=discord.ButtonStyle.secondary, label="4", row=2)
    async def four(self, button: discord.ui.Button, interaction: discord.Interaction):
        self.expr += "4"
        await interaction.message.edit(content=f"```\n{self.expr}\n```")

    @discord.ui.button(style=discord.ButtonStyle.secondary, label="5", row=2)
    async def five(self, button: discord.ui.Button, interaction: discord.Interaction):
        self.expr += "5"
        await interaction.message.edit(content=f"```\n{self.expr}\n```")

    @discord.ui.button(style=discord.ButtonStyle.secondary, label="6", row=2)
    ...
    @discord.ui.button(style=discord.ButtonStyle.secondary, label="  ", row=2)
    async def bruh3(self, button: discord.ui.Button, interaction: discord.Interaction):
        self.expr = ""

    @discord.ui.button(style=discord.ButtonStyle.secondary, label="1", row=3)
    async def one(self, button: discord.ui.Button, interaction: discord.Interaction):
        self.expr += "1"
        await interaction.message.edit(content=f"```\n{self.expr}\n```")

    @discord.ui.button(style=discord.ButtonStyle.secondary, label="2", row=3)
    async def two(self, button: discord.ui.Button, interaction: discord.Interaction):
        self.expr += "2"
        await interaction.message.edit(content=f"```\n{self.expr}\n```")

    @discord.ui.button(style=discord.ButtonStyle.secondary, label="3", row=3)
    ...
    @discord.ui.button(style=discord.ButtonStyle.secondary, label="  ", row=3)
    async def bruh4(self, button: discord.ui.Button, interaction: discord.Interaction):
        self.expr = ""
    ...
    @discord.ui.button(style=discord.ButtonStyle.secondary, label="0", row=4)
    ...
    @discord.ui.button(style=discord.ButtonStyle.secondary, label=" ", row=4)
    async def bruh5(self, button: discord.ui.Button, interaction: discord.Interaction):
        self.expr = ""
